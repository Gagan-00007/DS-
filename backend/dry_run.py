"""
Self-contained dry-run script testing all 14 core steps of the Classroom Attendance system.
...
def run_dry_run():
    ...
    # Load synthetic embedding generated by seed.py
    ...
    # Helper dummy frame generator for checkpoint endpoint
    ...
    # Step 5: Active Timetable Lookup
    ...
    # Step 6: Entry Checkpoint Scan (Live + Recognized match)
    ...
    # Step 7: Student Attendance Retrieval
    ...
    # Step 8: Section Attendance Retrieval (Teacher view)
    ...
    # Step 9: Teacher Attendance Correction
    ...
    # Step 10: Audit Trail Inspection
    if corrected_record_id:
    ...
    # Step 11: Monthly Absence Threshold Check Trigger
    ...
    # Step 12: Teacher Notifications Check
    notif_id = None
    ...
    # Step 13: Spoof Detection Check (Liveness Failure Regression)
    ...
    # Step 14: Notification Mark Read Check
    if notif_id:
        res14 = client.post(f"/notifications/{notif_id}/read", headers=headers_teacher)
        if res14.status_code == 200 and res14.json().get("is_read") is True:
            print_result(14, "Notification Mark Read Check", True, f"Notification {notif_id} marked as read")
        else:
            print_result(14, "Notification Mark Read Check", False, res14.text)
    else:
        print_result(14, "Notification Mark Read Check", False, "No notification ID available to mark read")
